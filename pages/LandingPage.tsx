...
// NaijaShop Landing Page with Bot Integration
// ============================================
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] bg-white/80 backdrop-blur-xl border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            {/* Login Button - No interception needed */}
            <button 
              onClick={onStartTrial} 
              data-ns-no-intercept="true"
              className="hidden md:block text-sm font-black text-slate-500 uppercase tracking-widest hover:text-emerald-600 transition-colors"
            >
              Login
            </button>
            
            {/* Nav CTA - ADDED data-cta attribute */}
            <button 
              onClick={onStartTrial}
              data-cta="free-trial"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left space-y-8 max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                {/* PRIMARY HERO CTA - UPDATED with both attributes */}
                <button 
                  onClick={onStartTrial}
                  data-cta="free-trial"
                ...
                <div className="flex -space-x-3 items-center">
                   ...
                   <p className="ml-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                     +500 Active Terminals
                   </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 relative animate-in fade-in zoom-in duration-1000">
               <div className="relative z-20 transform hover:scale-105 transition-transform duration-700">
                  <div className="absolute -inset-4 bg-emerald-500/20 blur-[100px] rounded-full" aria-hidden="true" />
                  <div className="overflow-hidden rounded-[3rem] shadow-2xl bg-white">
                    <img 
                      src="https://i.ibb.co/W4XQSpqw/IMG-20260125-230934.png" 
                      alt="NaijaShop App showing inventory management dashboard" 
               ...
               {/* Floating Badges */}
               <div 
                 className="absolute -top-10 -right-4 lg:-right-10 bg-white p-6 rounded-[2rem] shadow-2xl animate-bounce-soft z-30 border border-slate-100 hidden sm:block"
                 aria-hidden="true"
               >
               ...
               <div 
                 className="absolute bottom-10 -left-4 lg:-left-10 bg-slate-900 p-6 rounded-[2rem] shadow-2xl z-30 animate-pulse hidden sm:block"
                 aria-hidden="true"
               >
                  <div className="flex items-center gap-3">
                     <div className="w-10 h-10 bg-rose-50 rounded-xl flex items-center justify-center text-white">
                       <ShieldAlert size={20} />
                     </div>
                     <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
             ...
             <p className="text-lg text-slate-500 font-medium">
               Professional tools designed to empower local businesses and secure their daily revenue.
             </p>
          </div>
            ...
            >
               <div className="aspect-[16/10] bg-indigo-50 rounded-[3rem] overflow-hidden border border-indigo-100 relative shadow-xl">
                  <img 
                    ...
                    alt="AI-powered notebook scanner converting handwritten ledger to digital inventory" 
                  ...
                  <div className="absolute top-8 left-8 bg-white/80 backdrop-blur-md px-4 py-2 rounded-full border border-indigo-100 shadow-xl flex items-center gap-2">
                     <Zap size={14} className="text-indigo-600 fill-indigo-600" aria-hidden="true" />
            ...
            >
               <div className="aspect-[16/10] bg-rose-50 rounded-[3rem] overflow-hidden border border-rose-100 relative shadow-xl">
                  <img 
                    ...
                    alt="Audit trail logs showing staff activity and transaction history" 
                    className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-1000"
                    loading="lazy"
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute top-8 left-8 bg-white/80 backdrop-blur-md px-4 py-2 rounded-full border border-rose-100 shadow-xl flex items-center gap-2">
                     <ShieldCheck size={14} className="text-rose-600" aria-hidden="true" />
            ...
            <div className="flex-1 space-y-10">
               <div className="space-y-6">
                  <h2 className="text-4xl lg:text-5xl font-black tracking-tighter leading-tight">
                    Scale Your Inventory <br className="hidden lg:block"/> Fully Offline.
                  </h2>
               ...
               {/* DEMO CTA - ADDED data-cta attribute */}
               <button 
                  onClick={onStartTrial}
                  data-cta="demo"
                  className="bg-white text-slate-900 px-10 py-6 rounded-[2rem] font-black text-lg hover:bg-emerald-50 transition-all flex items-center justify-center gap-3 group"
               >
                 Try the Terminal 
                 <ArrowRight className="group-hover:translate-x-1 transition-transform" aria-hidden="true" />
               </button>
            ...
            <div className="flex-1 relative">
               <div className="overflow-hidden rounded-[2.5rem] shadow-2xl border-4 border-slate-800 bg-white">
                <img 
                  ...
                  alt="Inventory management screen showing product list and stock levels" 
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-12">
           <div className="w-24 h-24 rounded-full overflow-hidden mx-auto border-4 border-white shadow-2xl">
              <img 
                ...
                alt="Amaka O., Retail Consultant from Lagos" 
                className="w-full h-full object-cover" 
                loading="lazy"
                referrerPolicy="no-referrer"
              />
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
           <div className="text-center mb-20 space-y-4">
              ...
              <p className="text-lg text-slate-500 font-medium">Get started in 3 simple steps</p>
           </div>
              ...
              <div className="text-center space-y-6">
                 <div className="aspect-[4/3] rounded-[2rem] bg-slate-50 border border-slate-100 overflow-hidden relative shadow-inner group">
                    <img 
                      ...
                      alt="Step 1: Installing the NaijaShop PWA on mobile device" 
                      className="w-full h-full object-cover transform group-hover:scale-105 transition-transform" 
                      loading="lazy"
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute top-4 left-4 w-10 h-10 bg-emerald-600 text-white rounded-full flex items-center justify-center font-black" aria-hidden="true">
                      1
                    </div>
                 </div>
              ...
              <div className="text-center space-y-6">
                 <div className="aspect-[4/3] rounded-[2rem] bg-slate-50 border border-slate-100 overflow-hidden relative shadow-inner group">
                    <img 
                      ...
                      alt="Step 2: Configuring shop profile and security PIN" 
                      className="w-full h-full object-cover transform group-hover:scale-105 transition-transform" 
                      loading="lazy"
                      referrerPolicy="no-referrer"
                    />
              ...
              <div className="text-center space-y-6">
                 <div className="aspect-[4/3] rounded-[2rem] bg-emerald-600 border border-emerald-500 overflow-hidden relative shadow-2xl group">
                    <img 
                      ...
                      alt="Step 3: Processing your first sale with NaijaShop" 
                      className="w-full h-full object-cover transform group-hover:scale-105 transition-transform" 
                      loading="lazy"
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute top-4 left-4 w-10 h-10 bg-white text-emerald-600 rounded-full flex items-center justify-center font-black" aria-hidden="true">
                      3
                    </div>
                 </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-500 font-medium mt-4">Start free, upgrade when you're ready</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            
            {/* ─────────────────────────────────────
                PRICING CARD 1: Free Trial
                ───────────────────────────────────── */}
            <div className="bg-white p-10 rounded-[3rem] border border-slate-200 shadow-sm flex flex-col hover:border-emerald-500 transition-all group">
              ...
              {/* FREE TRIAL CTA - ADDED data-cta */}
              <button 
                onClick={onStartTrial} 
                data-cta="free-trial"
                className="mt-10 w-full py-4 bg-slate-100 text-slate-600 rounded-2xl font-black text-xs uppercase tracking-widest group-hover:bg-emerald-600 group-hover:text-white transition-all active:scale-95"
              >
                Get Started
              </button>
            </div>
            ...
            {/* ─────────────────────────────────────
                PRICING CARD 2: Annual (Recommended)
                ───────────────────────────────────── */}
            <div className="bg-white p-10 rounded-[3rem] border-4 border-emerald-600 shadow-2xl flex flex-col relative scale-105 z-10">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-emerald-600 text-white px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest">
                Recommended
              </div>
              <div className="flex-1">
              ...
              {/* SUBSCRIBE CTA - ADDED data-cta */}
              <button 
                onClick={onStartTrial} 
                data-cta="pricing"
                data-plan="annual"
                className="mt-10 w-full py-5 bg-emerald-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl shadow-emerald-900/20 hover:bg-emerald-700 transition-all active:scale-95"
              >
                Subscribe Now
              </button>
            </div>
            ...
            <div className="bg-white p-10 rounded-[3rem] border border-slate-200 shadow-sm flex flex-col hover:border-indigo-500 transition-all group">
              <div className="flex-1">
                ...
                <ul className="space-y-4" role="list">
                  {[ 
                    ...
                    <li key={i} className="flex items-center gap-3 text-sm font-medium text-slate-500">
                      <CheckCircle2 size={16} className="text-indigo-500 shrink-0" aria-hidden="true" /> 
                      {feature}
                    </li>
                  ))}
                </ul>
              ...
              {/* LIFETIME CTA - ADDED data-cta */}
              <button 
                onClick={onStartTrial} 
                data-cta="signup"
                data-plan="lifetime"
                className="mt-10 w-full py-4 bg-slate-100 text-slate-600 rounded-2xl font-black text-xs uppercase tracking-widest group-hover:bg-indigo-600 group-hover:text-white transition-all active:scale-95"
              >
                Go Unlimited
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
             ...
             <div className="col-span-2 space-y-6">
                ...
                <div>
                   ...
                   <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">
                     Enterprise Solutions for Nigeria
                   </p>
                </div>
                <p className="text-slate-500 font-medium max-w-sm leading-relaxed">
                  Empowering African retailers with offline business intelligence. The industry standard for digital inventory management.
                </p>
             </div>
             ...
             <div>
                ...
                <ul className="space-y-4">
                   <li>
                     <a 
                       href="/affiliate" 
                       className="text-sm font-bold text-slate-700 hover:text-emerald-600 flex items-center gap-2 transition-colors"
                     >
                       <Users size={16} aria-hidden="true" /> Partner Program
                     </a>
                   </li>
                   <li>
                     <a 
                       ...
                       className="text-sm font-bold text-slate-700 hover:text-emerald-600 flex items-center gap-2 transition-colors"
                     >
                       <Globe size={16} aria-hidden="true" /> Documentation
                     </a>
                   </li>
                </ul>
             </div>
             ...
             <div>
                ...
                <ul className="space-y-4">
                   <li>
                     <a 
                       href="/support" 
                       className="text-sm font-bold text-emerald-600 hover:text-emerald-700 flex items-center gap-2 transition-colors"
                     >
                       <MessageCircle size={16} aria-hidden="true" /> Professional Support
                     </a>
                   </li>
          ...
          <div className="pt-8 border-t border-slate-50 text-center">
             <p className="text-[9px] font-black text-slate-300 uppercase tracking-[0.3em]">
               &copy; {new Date().getFullYear()} NaijaShop Infrastructure. All Rights Reserved.
             </p>
          </div>
        </div>
      </footer>
